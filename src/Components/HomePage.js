  ...
  return (
    <>
	  ...
	  <div className="options">
        <Fade left delay={start} duration={2500}>
          <div onClick={handleGame} className="option card fancyFont bigText">PLAY</div>
        </Fade>
	...
	<div></div>
	  ...
	  {ShowInst? 
	   <Bounce left duration={1000}>
	   <div id="instructions" className="inst options newcard  bigText">
		<div className="close" onClick={handleInstructions}>❌</div>
		 ...
		 Computer will choose a random movie and display all the vowels, <br/>
            ...
            You can guess a maximum of 5 wrong letters!<br/>
